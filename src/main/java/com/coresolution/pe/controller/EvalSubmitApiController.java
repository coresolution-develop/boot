...
public class EvalSubmitApiController {
    ...
    @PostMapping(value = "/formAction/edit/{eval}/{target}/{ev}/{type}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)

...
/**
 * 계열사 기관 관리자 전용 평가 창구(오픈/마감) 설정 컨트롤러.
 *
 * <p>모든 데이터 조회/수정은 세션의 institutionName(= c_name) 범위로 자동 제한됩니다.</p>
 */
@Slf4j
@Controller
@RequestMapping("/aff/inst-admin/evalrelease")
@PreAuthorize("hasRole('INST_ADMIN')")
@RequiredArgsConstructor
public class AffInstAdminReleaseController {
    ...
    public String page(HttpServletRequest req, Model model) {
        ...
        return "aff/inst-admin/evalrelease";
    }

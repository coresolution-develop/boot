...
@Mapper
public interface AffAdminMapper {
  ...
  @Select("""
          ...
          FROM personnel_evaluation_aff.result_release_gate
  ...
  @Insert("""
          INSERT INTO personnel_evaluation_aff.result_release_gate(page_key, eval_year, open_at, close_at, enabled)

...
@Mapper
public interface AffEvalSubmissionMapper {
  // 활성본 소프트삭제: del_yn='Y', is_active=0
  @Update("""
          UPDATE personnel_evaluation_aff.evaluation_submissions
             SET del_yn    = 'Y',
                 is_active = 0,
                 updated_at = NOW(),
           ...
           WHERE eval_year    = #{year}
             ...
             AND is_active = 1
      """)
  int softDeleteActive(@Param("year") int year,
  ...
  @Select("""
          SELECT COALESCE(MAX(version),0)
            FROM personnel_evaluation_aff.evaluation_submissions
           WHERE eval_year    = #{year}
             AND evaluator_id = #{evaluatorId}
             AND target_id    = #{targetId}
             AND data_type    = #{dataType}
             AND data_ev      = #{dataEv}
      """)
  int findMaxVersion(@Param("year") int year,
      @Param("evaluatorId") String evaluatorId,
      @Param("targetId") String targetId,
      @Param("dataType") String dataType,
      @Param("dataEv") String dataEv);
  ...
  // 새 버전 INSERT (활성본으로)
  @Insert("""
          INSERT INTO personnel_evaluation_aff.evaluation_submissions
  ...
  @Select("""
          SELECT id, eval_year, evaluator_id, target_id, data_ev, data_type,
           ...
           LIMIT 1
      """)
  EvalSubmissionRow findActiveSubmission(@Param("year") int year,
      @Param("evaluatorId") String evaluatorId,
      @Param("targetId") String targetId,
      @Param("dataType") String dataType,
      @Param("dataEv") String dataEv);
  ...
  @Select("""
          SELECT id,
           ...
           LIMIT 1
      """)
  EvaluationSubmission findActiveStrict(@Param("year") int year,
      @Param("evaluatorId") String evaluatorId,
      @Param("targetId") String targetId,
      @Param("dataType") String dataType,
      @Param("dataEv") String dataEv);
  ...
  @Select("""
          SELECT id,
           ...
           LIMIT 1
      """)
  EvaluationSubmission findLatestStrict(@Param("year") int year,
      @Param("evaluatorId") String evaluatorId,
      @Param("targetId") String targetId,
      @Param("dataType") String dataType,
      @Param("dataEv") String dataEv);
  ...
  @Select("""
          SELECT id,
           ...
           LIMIT 1
      """)
  EvaluationSubmission findLatestLoose(@Param("year") int year,
      @Param("evaluatorId") String evaluatorId,
      @Param("targetId") String targetId);
  ...
  @Select("""
          SELECT answered_count
           ...
           LIMIT 1
      """)
  Integer findAnsweredCount(@Param("year") int year,
      @Param("evaluatorId") String evaluatorId,
      @Param("targetId") String targetId,
      @Param("dataType") String dataType,
      @Param("dataEv") String dataEv);
  ...
  @Select("""
          SELECT avg_score
           ...
           LIMIT 1
      """)
  Double findAvgScore(@Param("year") int year,
      @Param("evaluatorId") String evaluatorId,
      @Param("targetId") String targetId,
      @Param("dataType") String dataType,
      @Param("dataEv") String dataEv);
  ...
  @Update("""
          UPDATE personnel_evaluation_aff.evaluation_submissions
           ...
           WHERE eval_year    = #{year}
             ...
             AND is_active    = 1
      """)
  int deactivateActive(@Param("year") int year,
      @Param("evaluatorId") String evaluatorId,
      @Param("targetId") String targetId,
      @Param("dataType") String dataType,
      @Param("dataEv") String dataEv);
  ...
  @Select("""
      ...
      LEFT JOIN personnel_evaluation_aff.users_${year} u
      ...
      """)
  List<EvaluationSubmission> selectReceivedAll(@Param("year") int year,
      @Param("targetId") String targetId);
  ...
  @Select("""
      ...
      WHERE eval_year = #{year}
        ...
        AND is_active = 1
      """)
  int countReceivedList(@Param("year") int year, @Param("targetId") String targetId);
  ...
  @Select("""
      ...
      ORDER BY data_ev
      """)
  List<Map<String, Object>> aggregateByRelation(@Param("year") int year, @Param("targetId") String targetId);
}

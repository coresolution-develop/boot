...
import com.coresolution.pe.mapper.AffAdminProgressByOrgMapper;

import lombok.RequiredArgsConstructor;

@Service
@RequiredArgsConstructor
public class AffAdminProgressByOrgService {

    private final AffAdminProgressByOrgMapper mapper;
    ...
    public Map<String, Object> list(int year, String org, String ev, String search, String sort) {
        String usersTable = "personnel_evaluation_aff.users_" + year;

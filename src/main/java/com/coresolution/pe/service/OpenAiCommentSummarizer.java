...
public class OpenAiCommentSummarizer implements CommentSummarizer {
    ...
    public String summarize(List<String> comments, String localeTag, int maxChars) {
        ...
        String system = """
                ...
                - 코멘트(essays) 수가 적더라도(예: 0~2건) summary, strengths, improvements를 짧게 줄이지 마십시오.
                - 코멘트가 빈약할 때는 다음 4가지 구성요소로 summary 분량(6~7문장)을 충족시키십시오.
                  (1) 1~2문장: 제공된 코멘트에서 읽히는 사실(있다면) 정리.
                  (2) 1문장: 표본이 적다는 한계 명시(예: "코멘트 표본이 적어 일반화에는 주의가 필요합니다.").
                  (3) 2~3문장: 인사평가 맥락에서 일반적으로 중요한 행동 원칙·관찰 포인트.
                  (4) 1~2문장: 다음 평가구간에서 확인할 관찰·검증 포인트.
                - strengths/improvements는 코멘트가 부족해도 (3)의 일반 원칙·관찰 포인트를 근거로 정확히 3개씩 작성합니다. 빈 배열 금지.

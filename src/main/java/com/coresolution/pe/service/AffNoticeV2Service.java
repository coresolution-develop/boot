...
import com.coresolution.pe.mapper.AffNoticeV2Mapper;
...
public class AffNoticeV2Service {
    private final AffNoticeV2Mapper mapper;
    private static final DateTimeFormatter F = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm");

    public List<NoticeV2> getActiveNoticesaff(int evalYear) {
        return mapper.findActiveaff(evalYear);
    }
